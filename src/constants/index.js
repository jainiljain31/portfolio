...
const projects = [
  {
    name: "Myntra Clone",
    description:
      "I developed a responsive clone of Myntra, an e-commerce platform, using only HTML and CSS. The project focuses on replicating the UI design, including the homepage layout, product listings, and navigation. It showcases my ability to create clean, structured code and implement modern, user-friendly designs.",
    tags: [
      {
        name: "html",
